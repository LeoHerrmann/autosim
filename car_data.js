const car_data = [
    {
        ...
        sound: {
            ...
            update_sound: function() {
                ...
                car.sound.gains[0].gain.value = 0.04 + (car.data.throttle) * 0.1;
                ...
                car.sound.gains[2].gain.value = 0.03 + (car.data.throttle) * 0.04;

                car.sound.oscillators[7].frequency.value = (car.data.rpm / 60 / 2 * 4) * (6 / 4);
                car.sound.gains[7].gain.value = 0.03 + (car.data.throttle) * 0.03;
                ...
                car.sound.gains[5].gain.value = 0.02 + (car.data.throttle) * 0.03;

                car.sound.oscillators[4].frequency.value = (car.data.rpm / 60 / 2 * 4) * (12 / 4);
                car.sound.gains[4].gain.value = 0.02 + (car.data.throttle) * 0.02;

                car.sound.oscillators[6].frequency.value = (car.data.rpm / 60 / 2 * 4) * (16 / 4);
                car.sound.gains[6].gain.value = 0.01 + (car.data.throttle) * 0.005;
            }
        }
    },
