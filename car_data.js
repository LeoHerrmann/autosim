const car_data = [
    {
        ...
        properties: {
            ...
            sound: {
                ...
                base_gains: [0.05, 0.02, 0.04, 0.04, 0.03, 0.03, 0.03, 0.02],
                throttle_gains: [0.1, 0.02, 0.05, 0.04, 0.04, 0.04, 0.03, 0.005]
            }
        }
    },
...

    {
        ...
        properties: {
            ...
            sound: {
                ...
                throttle_gains: [0.1, 0.02, 0.05, 0.04, 0.04, 0.03, 0.03, 0.01]
            }
        }
    }
];
